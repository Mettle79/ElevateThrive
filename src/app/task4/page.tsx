        ...
        <Card className="w-full max-w-md bg-[#1E1E1E] text-white border-orange-700">
          <CardContent className="p-6">
            ...
            <div className="flex justify-center">
              <Link href="/task8">
                <Button className="bg-orange-600 hover:bg-orange-700">Proceed to Task 8</Button>
              </Link>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent className="p-6">
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              className="w-full bg-orange-400 hover:bg-orange-400/80 text-orange-900 disabled:opacity-50"
            >
              Complete Challenge
            </Button>
